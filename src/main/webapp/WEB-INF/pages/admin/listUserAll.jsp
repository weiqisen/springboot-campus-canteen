...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a onclick="location='index'">首页</a>
        ...
        用户管理
        <span class="c-gray en">&gt;</span>
        所有用户 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                ...
                <span class="c">
                    <a>Tip:管理员只能修改用户无法修改的信息的权利：如姓名，学号,性别</a>
                     <div class="navigation-search d-none d-lg-block">
                                <form method="post" action="/findByName">
                                    <input type="search" placeholder="根据姓名查找" name="name">
                                    <button type="submit"><a>搜索</a></button>
                                </form>
                            </div>
                </span>
